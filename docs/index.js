...
var _user$project$EmbeddedGist$noPadding = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Main$result = F3(
	function (onErr, onOk, res) {
		var _p0 = res;
		if (_p0.ctor === 'Err') {
			return onErr(_p0._0);
		} else {
	...
	function (msg, model) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					targetGist: _elm_lang$core$Maybe$Just(_p1._0)
				}),
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: function () {
				var _p3 = memb;
				if (_p3.ctor === 'Just') {
					return _user$project$EmbeddedGist$unsafeEmbeddedGist(
						_user$project$Main$gistIdentifier(_p3._0));
				} else {
					return _elm_lang$html$Html$text('(No gist selected)');
				}
			}(),
			_1: {ctor: '[]'}
		});
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {targetGist: _elm_lang$core$Maybe$Nothing},
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$SelectTargetGist = function (a) {
	return {ctor: 'SelectTargetGist', _0: a};
};
var _user$project$Main$gistSelector = function (mtarget) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Attributes$disabled(
						_elm_lang$core$Native_Utils.eq(
							mtarget,
							_elm_lang$core$Maybe$Just(_user$project$Main$GistDefault))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$SelectTargetGist(_user$project$Main$GistDefault)),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_user$project$Main$gistIdentifier(_user$project$Main$GistDefault)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_0: _elm_lang$html$Html_Attributes$disabled(
							_elm_lang$core$Native_Utils.eq(
								mtarget,
								_elm_lang$core$Maybe$Just(_user$project$Main$GistMap))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$SelectTargetGist(_user$project$Main$GistMap)),
							_1: {ctor: '[]'}
						}
					},
					{
